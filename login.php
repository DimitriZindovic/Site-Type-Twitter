                  ...
                  <form action="session.php" method="POST" class="mx-1 mx-md-4">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input placeholder="Veuillez entrez votre email" type="email" name="email" id="form3Example3c"
                          class="form-control" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input placeholder="Veuillez entrez votre mot de passe" type="password" name="password"
